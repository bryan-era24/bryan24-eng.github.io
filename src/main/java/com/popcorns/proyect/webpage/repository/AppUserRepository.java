package com.popcorns.proyect.webpage.repository;
...
import com.popcorns.proyect.webpage.utils.EncrytedPasswordUtils;
...
public class AppUserRepository {
    ...
    public AppUser createAppUser(Connection<?> connection) {
        ...
        this.appRole.createRoleFor(appUser, roleNames);
