package com.popcorns.proyect.webpage.config;

import com.popcorns.proyect.webpage.repository.AppUserRepository;
import com.popcorns.proyect.webpage.social.ConnectionSignUpImpl;
...
public class SocialConfig implements SocialConfigurer {
    ...
    public UsersConnectionRepository getUsersConnectionRepository(ConnectionFactoryLocator connectionFactoryLocator) {
        ...
        if (autoSignUp) {
            ...
            ConnectionSignUp connectionSignUp = new ConnectionSignUpImpl(appUser);
